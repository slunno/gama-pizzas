import { FaPizzaSlice, FaFire, FaUsers } from "react-icons/fa";
    ...
    <section className="history" id="historia">
      <div className="history-container">
        <div className="history-image" data-aos="fade-right">
          <img src={pizzaImg} alt="Gama Pizzas" />
        </div>

        <div className="history-content" data-aos="fade-left">
          <span>Nossa História</span>

          <h2>Mais que pizzas, criamos momentos</h2>

          <p>
            A Gama Pizzas nasceu com o propósito de levar uma experiência
            completa de rodízio até eventos especiais.
          </p>

          <p>
            Trabalhamos com ingredientes selecionados, equipe preparada e
            estrutura própria.
          </p>
