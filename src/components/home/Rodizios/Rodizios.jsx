    ...
    <section className="rodizios" id="rodizios">
      <div className="rodizios-container">
        <div className="section-header">
          ...
          <h2>Escolha a melhor opção para o seu evento</h2>

          <p>
            Levamos toda a estrutura necessária: forno, ingredientes, pizzaiolo
            e equipe preparada para transformar seu evento em uma experiência
            inesquecível.
          </p>
        </div>
        ...
        <div className="menu-grid">
          {menus.map((menu, index) => (
            <div
              ...
              key={index}
            >
              {menu.highlight && <div className="badge">Mais escolhido</div>}
        ...
        <div className="flavors-section">
          ...
          <div className="flavors-grid">
            {Object.values(flavors).map((menu, index) => (
              <div className="flavors-card" key={index}>
                <h3>🍕 {menu.title}</h3>
